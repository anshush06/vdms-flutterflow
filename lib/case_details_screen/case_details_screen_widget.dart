                                            ...
                                            if (getJsonField(
                                              ...
                                              _model.submitSurveyAPIResponse =
                                                ...
                                                inspectionFormData: functions.convertDataToJson(
                                                    ...
                                                    functions.convertAdditionalRemarksToList(widget.selectedCaseDetails?.inspectionFormData.anyOtherInformation.toList()).map((e) => e.toString()).toList(),
                                                    functions.convertFloorDetailsToList(widget.selectedCaseDetails?.inspectionFormData.floorwiseDetails.toList()).map((e) => e.toString()).toList()),
                                              );
